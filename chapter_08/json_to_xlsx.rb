...
# Note: Depending on what contents are in the file, you may need to force the encoding to UTF-8. You can do so like this: encoded_file_content = f.read.force_encoding('UTF-8’) Then pass the encoded_file_content to the JSON.parse method. 
